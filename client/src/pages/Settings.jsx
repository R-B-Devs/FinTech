    ...
    <div className="settings-container">
      ...
      <div className="settings-inner">
        ...
        <Section title="Security">
          ...
          >
            <Toggle
              ...
              onChange={() =>
                handleSecurityChange('biometric', !security.biometric)
              }
            />
          </SettingItem>
          <SettingItem
          ...
          >
            <select
              ...
              onChange={(e) =>
                handleSecurityChange('autoLock', e.target.value)
              }
            >
        ...
        <Section title="Privacy">
          <SettingItem
            icon={privacy.hideBalances ? EyeOff : Eye}
            title="Hide Balances"
            subtitle="Hide account balances on main screen"
          >
            <Toggle
              checked={privacy.hideBalances}
              onChange={() => handlePrivacyChange('hideBalances')}
            />
          </SettingItem>
          <SettingItem
            icon={Globe}
          ...
          >
            <Toggle
              ...
              onChange={() => handlePrivacyChange('analyticsSharing')}
            />
          </SettingItem>
        </Section>
        ...
        <Section title="Notifications">
          ...
          <SettingItem
            icon={Bell}
            title="Budget Alerts"
            subtitle="Notifications when you exceed budgets"
          >
            <Toggle
